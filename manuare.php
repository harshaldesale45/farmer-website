	...
	<div id="breadcrumb">
		<div class="container">	
			<div class="breadcrumb">							
				...
				<li><a href="manuare.php">Manure</li>			
			</div>		
...
<div class="container-fluid text-left">
  <h2>Select: </h2>
  <form action="manuaresort.php" method="post" class="form-inline">
	...
	&nbsp &nbsp
	<button type='submit3' name='submit3' value="submit3" class="btn btn-success">Submit</button>
	</form>
	<br>
