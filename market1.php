...
<div class="container-fluid text-left">
  <h2>Select: </h2>
  <form action="marketsort.php" method="post" class="form-inline">
    
		<div class="form-group">
      <label for="name" class="text-success">Product:</label>
      <input type="text" name="product"  maxlength='50' class="form-control"  id="product" placeholder="Apple,Banana,Orange" required >
    </div>
	&nbsp &nbsp
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
	<a href="storagezone.html" class="btn btn-success">Locate</button></a>
	</form>
	<br>
