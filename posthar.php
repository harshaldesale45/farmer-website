					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="contact.html">ChatBoxt</a></li>	
...
<div class="container-fluid text-left">
  <h2>Select: </h2>
  <form action="postsort.php" method="post" class="form-inline">
    
		
		<div class="form-group">
      <label for="name" class="text-success">Storage Type:</label>
      <input type="text" name="type"  maxlength='50' class="form-control"  id="type" placeholder="Cold Storge,Storage" required>
    </div>
	&nbsp &nbsp
	...
	&nbsp &nbsp
	<div class="form-group">
      <label for="name" class="text-success">Price:</label>
      <input type="text" name="price"  maxlength='50' class="form-control"  id="price" placeholder="Enter max amount" required >
    </div>
	&nbsp &nbsp
	
	<button type='submit' name='submit1' value="submit1" class="btn btn-success">Submit</button>
	</form>
	<br>
...
if ($result->num_rows > 0) {
  echo"<table class=td1>
   <thead class=tdgreen>
      <tr >
       <th class=td1>Storage Type</th>
       <th class=td1>District</th>
        <th class=td1>Area(in Yards)</th>
		 <th class=td1>Address</th>
			 <th class=td1>Rent </th>
    ...
    while($row = $result->fetch_assoc()) {
		 echo"<tbody>";
      echo "<tr >
        <td  class='tdRed'>".$row["type"]."</td>
       <td class='tdRed'>".$row["District"]."</td>
	   <td class='tdRed'>".$row["area"]."</td>
	     <td class='tdRed'>".$row["address"]."</td>
	   <td class='tdRed'>".$row["price"]."</td>
